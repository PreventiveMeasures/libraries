...
export const MAIN_MODELS = [
  ...
  ['anthropic/claude-3-haiku', { input: 0.25, output: 1.25, maxTokens: 4096, openRouterOnly: true }],
  ...
  ['openai/gpt-oss-120b', { input: 0.039, output: 0.19, maxTokens: 128 * 1024, openRouterOnly: true }],
