...
describe('what it refuses', () => {
  ...
  it('throws ZipError without an offset', async () => {
    await assert.rejects(zip([{}]), (error) => error instanceof ZipError && error.offset === undefined)
  })
